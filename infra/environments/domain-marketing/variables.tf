##############################################################################
# domain-marketing/variables.tf
#
# Variable declarations for the Marketing domain environment.
...
# ── Consumer-side: resource link DB and Athena workgroup ─────────────────────

variable "producer_account_id" {
  description = "Account ID of the producer domain (e.g. sales) whose gold tables are shared."
  type        = string
  default     = ""
}

variable "producer_gold_db_name" {
  description = "Glue database name in the producer account containing the gold tables."
  type        = string
  default     = "gold_sales"
}
